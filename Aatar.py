...
website.bind(('10.20.177.33', 1729))  # Change 'localhost' to your server's IP address
website.listen()
...
while True:
    ...
    content = generate_html_response("ziv",img_content=r"C:\Users\omerf\OneDrive\שולחן העבודה\tomer\idan&UDI\imeges\ball.jpg",vid_content= r"C:\Users\omerf\OneDrive\שולחן העבודה\tomer\idan&UDI\imeges\yair.mp4")  # Your centered word here
